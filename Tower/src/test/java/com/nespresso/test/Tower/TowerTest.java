package com.nespresso.test.Tower;

import static org.junit.Assert.assertEquals;

import org.junit.Test;
import com.nespresso.tower.Tower;
...
public class TowerTest {
	...
	public void test()
	{
		final Tower tower = new Tower();
		tower.addFloor(8);
		assertEquals("XXXXXXXX", tower.printFloor(0));
		tower.addFloorWithWindows(9, 3);
		assertEquals("XXX000XXX", tower.printFloor(1));
		tower.addFloor(8);
		assertEquals("X000X000X", tower.printFloor(1));
		tower.addFloor(8);
		assertEquals("X00X00X0X", tower.printFloor(1));
		tower.addFloor(8);
		assertEquals("X0X0X0X0X", tower.printFloor(1));
